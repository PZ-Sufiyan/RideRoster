...
const SubAdmin_NewDriver = () => {
    ...
    const handleRegister = async () => {
        ...
        setSubmitting(true);
        setTimeout(() => {
            pushToast('success', 'Driver created in UI flow.');
            setSubmitting(false);
            navigate('/subadmin/drivers');
        }, 500);
    };
        ...
        <div className="mx-auto space-y-0">
            ...
            <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-[0_2px_10px_-4px_rgba(6,81,237,0.07)] space-y-8 my-5">
                <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <FormField label="Password" required type="password" placeholder="Enter password" value={form.password} onChange={set('password')} showError={showMissing('password')} />
                            <FormField label="Confirm Password" required type="password" placeholder="Confirm password" value={form.confirmPassword} onChange={set('confirmPassword')} showError={showMissing('confirmPassword')} />
                        </div>
                ...
                <div>
                    ...
                    <div className="space-y-5">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <UploadBox label="Driving License (Front)" required file={files.driving_license_front} onFileChange={setFile('driving_license_front')} showError={showMissing('driving_license_front')} />
                            <UploadBox label="Driving License (Back)" required file={files.driving_license_back} onFileChange={setFile('driving_license_back')} showError={showMissing('driving_license_back')} />
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <UploadBox label="Taxi Badge (Front)" required file={files.taxi_badge_front} onFileChange={setFile('taxi_badge_front')} showError={showMissing('taxi_badge_front')} />
                            <UploadBox label="Taxi Badge (Back)" required file={files.taxi_badge_back} onFileChange={setFile('taxi_badge_back')} showError={showMissing('taxi_badge_back')} />
                        </div>
                        <ExpiryDateField value={form.taxiBadgeExpiry} onChange={setExpiry('taxiBadgeExpiry')} showError={showMissing('taxiBadgeExpiry')} />

                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <UploadBox label="DBS Certificate (Front)" required file={files.dbs_certificate_front} onFileChange={setFile('dbs_certificate_front')} showError={showMissing('dbs_certificate_front')} />
                            <UploadBox label="DBS Certificate (Back)" required file={files.dbs_certificate_back} onFileChange={setFile('dbs_certificate_back')} showError={showMissing('dbs_certificate_back')} />
                        </div>
                        <ExpiryDateField value={form.dbsExpiry} onChange={setExpiry('dbsExpiry')} showError={showMissing('dbsExpiry')} />

                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <FormField label="DBS Service Update ID Number" required placeholder="Enter DBS service update ID" value={form.dbsUpdateId} onChange={set('dbsUpdateId')} showError={showMissing('dbsUpdateId')} />
                            <UploadBox label="Derby City Safeguarding Certificate" hint="Must be less than 3 years old" file={files.safeguarding_certificate} onFileChange={setFile('safeguarding_certificate')} />
                        </div>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                                    <FormField label="Taxi License Plate Number" required placeholder="Taxi License Plate Number" value={form.taxiLicensePlate} onChange={set('taxiLicensePlate')} showError={showMissing('taxiLicensePlate')} />
                        ...
                        <SeatingCapacity value={form.seatingCapacity} onChange={set('seatingCapacity')} showError={showMissing('seatingCapacity')} />
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-3 pt-5 pb-2">
                ...
                <div className="flex items-center justify-between">
                    <button
                        type="button"
                        onClick={() => navigate('/subadmin/drivers')}
...
export default SubAdmin_NewDriver;
