            ...
            <div className="flex-1 bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 overflow-y-auto divide-y divide-gray-50">
                        {alerts.map((alert) => (
                            <div
                                ...
                                onClick={() => navigate(`/subadmin/sos/${alert.vehicleId}`)}
                            >
                ...
                <div className="flex-1 relative bg-[#F8F3E9]">
                    ...
                    <div
                        ...
                        onClick={() => navigate('/subadmin/sos/BH-1129')}
                    >
                    ...
                    <div
                        ...
                        onClick={() => navigate('/subadmin/sos/BH-1084')}
                    >
...
export default SubAdmin_SOSPage;
