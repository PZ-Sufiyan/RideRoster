...
const STEPS = ['Route Info', 'Passengers & Order', 'Schedule & Pay'];
...
function EditJobInner() {
    ...
    if (loading) {
        return (
            <LoadingStatus label="Loading job" className="max-w-[1280px] mx-auto pb-20 space-y-8">
                <div className="relative mb-12 px-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <ShimmerBlock className="rounded-2xl border border-gray-100 shadow-sm min-h-[500px] w-full" rounded="rounded-2xl" />
                </div>
            </LoadingStatus>
        );
    }
    ...
    if (error) {
        return (
            <div className="max-w-[1280px] mx-auto pb-20 space-y-4">
                ...
                <a href="/subadmin/jobs" className="text-[14px] font-bold text-[#004D6D] hover:underline">
                    Back to jobs
                </a>
            </div>
        );
