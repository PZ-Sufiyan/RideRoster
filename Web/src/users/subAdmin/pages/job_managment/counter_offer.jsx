...
const CounterOfferReview = () => {
    ...
    const canEditJobs = can('edit_jobs');
    ...
    const load = useCallback(async () => {
        ...
        try {
            ...
            if (!['counter request', 'counter requested'].includes(status)) {
                navigate(`/team/jobs/${id}`, { replace: true });
            }
        } catch (e) {
    ...
    const handleConfirm = async () => {
        ...
        try {
            if (confirm.type === 'accept') {
                ...
                navigate('/team/jobs', { replace: true });
            }
        } catch (e) {
            ...
            <div>
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    ...
                    {canEditJobs ? (
                        ...
                        <p className="text-[13px] text-gray-500 font-medium shrink-0">
                            View only — you need edit jobs permission to respond.
                        </p>
                    )}
                </div>
