...
const Admin_Register_ComplianceDocs = ({ onNext, onPrev }) => {
    return (
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-start">
                ...
                <div className="flex-1 space-y-6 min-w-0">
                    ...
                    <div className="bg-white border border-gray-200 rounded-3xl p-6 shadow-sm">
                        ...
                        <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-100 rounded-xl">
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded bg-red-100 text-red-500 flex items-center justify-center font-bold text-[10px]">PDF</div>
                                <div>
                            ...
                            <div className="flex items-center gap-2 text-gray-400">
                                <button className="p-1.5 hover:text-gray-700 transition-colors"><MdVisibility size={18} /></button>
                                <button className="p-1.5 hover:text-red-500 transition-colors"><MdDeleteOutline size={18} /></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-3xl p-6 shadow-sm">
                        <div className="flex items-start justify-between mb-6">
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-10 rounded-xl bg-gray-50 border border-dashed border-gray-100 text-gray-400 flex items-center justify-center">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex items-center justify-end pt-4 pb-10">
                        <button
                            onClick={onNext}
                            className="flex items-center gap-2 px-6 py-3 text-white rounded-xl text-[14px] font-bold hover:opacity-90 transition-all shadow-sm"
