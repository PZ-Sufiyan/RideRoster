...
class DriverNotificationItem {
  ...
  factory DriverNotificationItem.fromRow(Map<String, dynamic> row) {
...
class DriverNotificationService {
  ...
  Future<List<DriverNotificationItem>> fetchNotifications() async {
    ...
    return (rows as List)
        .map((row) => DriverNotificationItem.fromRow(
  ...
  RealtimeChannel subscribeRealtime(void Function() onChange) {
    final userId = _userId;
    if (userId == null || userId.isEmpty) {
      return _supabase.channel('driver-notifications-empty');
    }
