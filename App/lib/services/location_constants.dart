...
class LocationConstants {
  ...
  static const double completionRadiusMeters = 10;
  static const String pickupTooFarMessage =
      'You must be within 20 meters of the pickup location to complete this action.';

  static const String dropoffTooFarMessage =
      'You must be within 20 meters of the drop-off location to complete this action.';
