...
class _PaAssignedJobsPageState extends State<PaAssignedJobsPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<PaAssignedJobsProvider>().loadIfNeeded();
    });
  }
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: Consumer<PaAssignedJobsProvider>(
                builder: (_, provider, __) {
                  ...
                  return RefreshIndicator(
                    onRefresh: () =>
                        context.read<PaAssignedJobsProvider>().refresh(),
...
class _AppBar extends StatelessWidget {
  ...
  const _AppBar({required this.onNotificationsTap, required this.onProfileTap});
